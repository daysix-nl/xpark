   ...
   <div class="container lg:flex lg:justify-between mb-[85px] md:mb-[100px] lg:mb-[95px] xl:mb-[100px]">
      ...
      <div class="w-full lg:w-[524px] xl:w-[568px] md:grid md:grid-cols-2 lg:grid-cols-1 mt-[40px] md:mt-[70px] lg:mt-[unset]">
         <div class="mb-[40px] md:mb-[unset]">
            ...
            <a href="tel:<?php echo get_field('telefoonnummer', 'option');?>" class="text-15 leading-25 md:text-15 md:leading-25 lg:text-13 lg:leading-22 xl:text-15 xl:leading-25 text-[#000000] font-normal mt-[15px] md:w-[506px] lg:w-[428px] xl:w-[550px] block">Telefoon: <span class="text-[#FF6441]"><?php echo get_field('telefoonnummer', 'option');?></span></a>
            <a href="mailto:<?php echo get_field('e-mailadres', 'option');?>" class="text-15 leading-25 md:text-15 md:leading-25 lg:text-13 lg:leading-22 xl:text-15 xl:leading-25 text-[#000000] font-normal md:w-[506px] lg:w-[428px] xl:w-[550px] block">E-mail algemeen: <span class="text-[#FF6441]"><?php echo get_field('e-mailadres', 'option');?></span></a>
