...
<section class="<?php echo get_field('achtergrond');?> <?php echo get_field('padding_top');?> <?php echo get_field('padding_bottom');?>">
   <div class="container">
      <div class="w-full max-w-[1218px] pt-[65px] md:pt-[65px] lg:pt-[80px] xl:pt-[115px] pb-[25px] md:pb-[35px] lg:pb-[30px] xl:pb-[30px] flex justify-between items-end">
         <a href="/nieuws/" class="text-25 leading-25 md:text-30 md:leading-30 lg:text-26 lg:leading-26 xl:text-30 xl:leading-30 font-bold text-[#202624] flex items-center">Nieuws & Blog
         ...
         <div class="hidden lg:block">
             <a href="/nieuws/" class="grow-item text-14 leading-20 xl:text-16 xl:leading-24 font-bold px-[18px] xl:px-[20px] h-[41px] xl:h-[44px] flex items-center rounded-[7px] bg-[#64786E] text-white w-fit mt-[25px] lg:mt-[unset]">Overzicht
