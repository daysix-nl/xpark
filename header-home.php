...
<body <?php body_class( 'page-block scroll-nonactive xpark relative hamburger-nonactive form-close' ); ?>>
            ...
            <div class="w-[80px] md:w-[245px] lg:w-[unset] flex justify-end items-center lg:space-x-[64px] xl:space-x-[74px]">
                ...
                if( have_rows('menu', 'option') ):
                    ...
                    <div class="hover-dropdown relative">
                        <a href="<?php echo $link_url; ?>" class="lg:text-14 lg:leading-24 xl:text-16 xl:leading-30 text-[#202624] font-bold hidden lg:block" target="<?php echo $link_target; ?>"><?php echo $link_text; ?></a>
